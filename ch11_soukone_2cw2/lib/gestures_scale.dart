...
class gesturesScaleWidget extends StatefulWidget {
  const gesturesScaleWidget({super.key});

  @override
  State<gesturesScaleWidget> createState() => _gesturesScaleWidgetWidgetState();
}
...
class _gesturesScaleWidgetWidgetState extends State<gesturesScaleWidget> {
  @override
...
class _buildBode extends StatelessWidget {
  const _buildBode({super.key});
